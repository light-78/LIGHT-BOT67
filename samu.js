...
samu330.on('chat-update', async(sam) => {
	...
	mess = {
			...
			only: {
    			...
    			ownerB: '[❗] ¡Este comando solo puede ser utilizado por el creador del bot! ❌\nOsea, Samu: wa.me/+593969489665, Habla con el para que pueda cambiar el numero del owner en este bot',
	...
	const noreg = {
		...
		"currencyCode": "SYP",
		"priceAmount1000": "999999999999999999",
		"retailerId": "Guillermo By Traxnox",
		"productImageCount": 1
		},
		"businessOwnerJid": `0@s.whatsapp.net`
		}
	...
	const fspam = {
		...
		"vcard": 'BEGIN:VCARD\n' +
    		'Version:3.0\n' +
    		'TEL;type=CELL;type=VOICE;waid=593969489665:+593969489665\n' +
	...
	participant: `0@s.whatsapp.net`, ...(from ? {
		remoteJid: "status@broadcast" } : {}) }, 
			message: { 
				...
				"mimetype": 
				"image/jpeg", 
				"caption": "➫'*👑By Traxnox Crashing Groups!!🔥*'\n'😈Guillermo" ,
...
break
		...
		//»»————-　★　————-««\\
//˚ ༘✶ ⋆｡˚ ⁀➷  🔥 𝘓𝘰𝘨𝘰𝘴 Guillermo By Traxnox 🔥
